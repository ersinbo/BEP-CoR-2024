...
def apply_se3_augmentation(pcd,
    ...
    #print("Action gripper Translation") 
    #print(tabulate(action_gripper_trans,headers=['x coordinates','y coordinates','z coordinates'], tablefmt='orgtbl'))
    #print()
    ##print("Perturbed Translation") 
    #print(tabulate(perturbed_trans,headers=['x coordinates','y coordinates','z coordinates'], tablefmt='orgtbl'))
    #print()
    ...
    while torch.any(perturbed_trans < 0):
        ...
        for b in range(bs):
            ...
            #print(f"Trans_idx",trans_idx)
            #print(f"Trans_indicies",trans_indicies)
            # Code I added to make the z coordinates positive
            #trans_indicies[b][2] = np.abs(trans_indicies[b][2])
            #trans_indicies[b][1] = np.abs(trans_indicies[b][1])
            #trans_indicies[b][0] = np.abs(trans_indicies[b][0])
    ...
    #print(tabulate(action_trans,headers=['x coordinates','y coordinates','z coordinates'], tablefmt='orgtbl'))
    #print()
